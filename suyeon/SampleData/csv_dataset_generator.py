...
def generate_user_info_and_reviews(num_users=20000, min_reviews_per_user=1, max_reviews_per_user=5):
...
exercise_reviews_dataset = generate_user_info_and_reviews(num_users=20000, min_reviews_per_user=1, max_reviews_per_user=5)
