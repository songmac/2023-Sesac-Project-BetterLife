...
exercise_review_data_path = r'./data/exercise_review_data_1000.csv'
merge_df_path = r'./data/model_df.csv'
...
reader = Reader(rating_scale=(1, 5))
data = Dataset.load_from_df(merge_df[["사용자", "프로그램명", "가중평균"]], reader=reader)
